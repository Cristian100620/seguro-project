  ...
  incluirCliente = () => {
    ...
    addDoc(
      alumnaRef,
      {
        ...
        bien_asegurado: (this.cliente.bienAsegurado)?(this.cliente.bien_asegurado):"",
        monto_asegurado: (this.cliente.montoAsegurado)?(this.cliente.bien_asegurado):"",
  ...
  editarCliente = (id: string) => {
    ...
    updateDoc(
      document,
      {
        ...
        apellido: (this.cliente.apellido)?(this.cliente.apellido):"",
        nacimiento: (this.cliente.nacimiento)?(new Date(this.cliente.nacimiento)):new Date(),
        bien_asegurado: (this.cliente.bien_asegurado)?(this.cliente.bien_asegurado):"",
        monto_asegurado: (this.cliente.monto_asegurado)?(this.cliente.monto_asegurado):"",
